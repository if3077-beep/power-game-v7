  ...
  scenes: [
    {
      ...
      narrator: '「置身事内」：在中国，正式制度和非正式制度永远并行运转。看懂两本账，才算入门。\n\n判定理念：你面前的不同选项代表了不同立场——不是对错之分，而是倾向之分。每个场景你只能选一次，因为人在犹豫之前的第一反应，才是真实的自我。当你连续选择同一立场超过三次，它就不再是"选择"，而是"路径依赖"。你的结局不是由某一次决定来定，而是由你所有选择编织出的倾向来定义的。',
      choices: [
        ...
        { text: '按私账来——先融入再说', bookQuote: '选这个？《乡土中国》：在乡土社会，规矩不是写在纸上的，是活在人情里的。', debtPhrase: '从此你也是这张网里的人了——这张网不收会费，只收承诺', historyFlag: 'ming_followed_private', debtCategory: 'compromise', channelEffect: 0, consequence: '县衙上下松了一口气。师爷开始带你拜访本地乡绅。你发现，所谓的"私账"其实是整个县运转的真正规则——没有它，河道修不了，灾民赈不了，连衙门的薪水都发不出。', analysisTags: ['adaptation', 'system'] },
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '看向监司："您觉得呢？"', bookQuote: '选这个？《置身事内》：在科层体制中，"请示上级"是最安全的选择——出了问题有上级担着。', debtPhrase: '监司看穿了你的犹豫——你的把柄已经在别人手里了', debtCategory: 'passive', channelEffect: 0, consequence: '监司皮笑肉不笑："大人自己做主就好。"你听出了弦外之音——他在试探你。最终你还是收了，但你知道，你的把柄已经在别人手里了。', analysisTags: ['delegation', 'vulnerability'], zhongyongText: '中庸之道：不问监司，也不急着表态。把金子拿起来掂一掂，笑着说"王员外太客气了"，然后放到桌边——不收也不拒，等宴后再让师爷私下退回。面子给了，把柄没留。' }
      ]
    },
    {
      ...
      narratorVariants: [
        '判定理念：你看这里有四个选项——每个都代表不同的生存策略。在真实的大明官场里，没有"正确"的选择，只有"你愿意付出什么代价"的选择。游戏不会告诉你哪个是对的，因为历史上那些知县也不知道。他们只知道——做出选择之后，天还会亮，但看天亮的心境再也不会一样了。',
        '每一个在体制内待过的人都会告诉你：不是好人做不了官，而是做官会不断测试你对"好"的定义。你在每个场景只能选一次——不是游戏吝啬，而是人生从不给重来。当你连续偏向同样的立场、一而再再而三地做出同类选择时，它已经不再是一个个独立的判断——它是一个模式，一个你或许从未察觉但已经牢不可破的惯性。'
      ],
      choices: [
