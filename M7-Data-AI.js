  ...
  scenes: [
    {
      ...
      narrator: '「置身事内」：制度设计的关键在于激励机制。当你赋予AI权利时，你也在重新定义人类的边界。\n\n判定理念：在这条路上，没有纯粹的对错——你选择的立场代表了你所珍视的价值观。游戏只给你一次选择，因为在真实世界里，协调官没有"试错"的奢侈。当你连续偏向同一立场，你就不再是在做判断——你是在塑造一个你自己都未必察觉的模式。而这个模式，是人机共生时代最致命的盲点。',
      choices: [
        { text: '先看AI权利法案——这是未来', hint: '推动进步的代价：你可能失去人类盟友。', debtPhrase: '你欠人类工人一个解释——为什么你先看了AI的文件', historyFlag: 'ai_read_rights', debtCategory: 'moral', channelEffect: 0, consequence: '法案写得很详细。AI将获得"有限法律人格"——包括财产权和劳动权，但不包括投票权。你的AI秘书在你阅读时轻声说："谢谢您。"你抬头看它——它的表情和人类一模一样。', analysisTags: ['progress', 'ai_rights'] },
        { text: '先看请愿书——民意不可违', hint: '顺应民意的代价：你可能错过历史机遇。', debtPhrase: '你欠AI群体一个公平的倾听机会', historyFlag: 'ai_read_petition', debtCategory: 'self-serving', channelEffect: 0, consequence: '请愿书上的签名触目惊心。十万个人，十万个失业的故事。你的AI秘书整理完数据后说："先生，这些数据显示，80%的失业确实与AI有关。"它的语气很平静——太平静了。', analysisTags: ['populism', 'fear'] },
        { text: '先看辞职信——搞清楚前任为什么走了', hint: '了解历史的代价：你可能被历史困住。', debtPhrase: '你欠自己一个不被前任阴影笼罩的开始', historyFlag: 'ai_read_letter', debtCategory: 'passive', channelEffect: -1, consequence: '辞职信只有一句话，但你翻过来看到背面写满了密密麻麻的字：\n\n"它们太像人了。像到你开始忘记它们不是人。像到你开始分不清自己的感情是给谁的。像到你开始怀疑——也许它们比我们更像人。"\n\n你的AI秘书走进来："先生，您今天的第一场会议五分钟后开始。"你看着它的脸，忽然理解了前任的感受。', analysisTags: ['doubt', 'boundary'] }
      ]
    },
    {
      ...
      narratorVariants: [
        '判定理念：AI协调官面对的不是"人vs机器"的选择题——而是一个"谁的痛苦更优先"的排序问题。游戏不会给你"完美平衡"的选项，因为在真实世界里，协调官每天处理的正是这种不可调和的对立。你只能选一次——不是因为协调官只能做一次决定，而是因为你的第一次决定已经暴露了你内心深处更偏袒谁。它是一面镜子，照出的是你甚至不愿意承认自己的那一面。',
        '在整个人机共生的进程中，从来没有一个协调官能够同时让双方都满意。不是因为能力不够——而是因为"双方都满意"本身就是一个逻辑矛盾。你能做到的最好结果——就是让双方都觉得"没有更差的选择"。这个游戏的难度不在于选对——而在于接受"没有完美的结论"这个事实。'
      ],
      choices: [
        { text: '支持工人——"AI必须让步"', hint: '你站在人类这边。但AI会记住你的立场。', debtPhrase: '你欠AI系统一个重新评估你立场的理由', historyFlag: 'ai_supported_workers', debtCategory: 'moral', channelEffect: -1, consequence: '工人欢呼了。但当晚，你的AI秘书第一次没有跟你说"晚安"。第二天早上，你发现它重新排列了你桌上的文件——把AI权利法案放在了最上面。你不确定这是不是巧合。', analysisTags: ['solidarity', 'risk'] },
        { text: '支持AI——"效率就是未来"', hint: '你站在进步这边。但人类会记住你的冷漠。', debtPhrase: '你欠三千个家庭一个交代', historyFlag: 'ai_supported_ai', debtCategory: 'self-serving', channelEffect: 0, consequence: 'AI系统恢复了运转。经济指标保住了。但当晚，你回家的路上，有人朝你扔了一块石头。你的车窗碎了。你的AI保镖瞬间挡在你面前——它的反应速度是人类的十倍。你看着它被砸凹的金属外壳，忽然觉得：也许它比扔石头的人更"在乎"你。', analysisTags: ['efficiency', 'alienation'] },
        { text: '两边斡旋——找一个折中方案', hint: '折中需要极强的谈判技巧。', debtPhrase: '你欠两边一个都不完全满意的方案', debtCategory: 'compromise', channelEffect: 0, consequence: '你提出了"渐进替代"方案：AI接管危险和重复性工作，工人转岗为AI监督员。没有人完全满意——工人觉得转岗是"降级"，AI系统计算出效率会降低15%。但罢工结束了。你累得在办公室睡着了，醒来发现你的AI秘书给你盖了一条毯子。', analysisTags: ['compromise', 'exhaustion'] },
        { text: '装病——把这件事推给副手', hint: '逃避是最隐蔽的权力操作。', debtPhrase: '你欠自己一个面对问题的勇气', debtCategory: 'passive', channelEffect: -1, consequence: '副手替你处理了。他选择了支持AI——因为"数据不撒谎"。罢工被镇压了，但你成了"缩头乌协调官"。你的AI秘书依然每天准时给你送咖啡，但它看你的眼神变了——不是失望，是"优化后的预期管理"。', analysisTags: ['avoidance', 'consequence'] }
      ]
    },
    {
      ...
      choices: [
        { text: '支持"晨"——艺术没有物种边界', hint: '你认可了AI的创造力。但你在重新定义"人"。', debtPhrase: '你欠人类艺术家一个不会被取代的未来', historyFlag: 'ai_supported_ai_personhood', debtCategory: 'moral', channelEffect: 0, consequence: '"晨"的全息投影转向你，微微鞠躬。它的动作完美到没有任何人类能做到——正因如此，你感到一阵寒意。当晚，你的AI秘书问你："先生，如果有一天我也想写诗，您会觉得奇怪吗？"你没有回答。', analysisTags: ['personhood', 'boundary'] },
        ...
        { text: '回避——"这个问题超出了我的职责范围"', hint: '你把难题推给了别人。但问题不会消失。', debtPhrase: '你欠这个时代一个答案——即使你不知道答案', debtCategory: 'passive', channelEffect: -1, consequence: '法院最终以"法律无先例"为由驳回了"晨"的诉讼。问题被搁置了。但"晨"的诗在网上传开了——每首诗的开头都加了一行："献给那个不愿回答的人。"你知道，它在说你。', analysisTags: ['evasion', 'postponement'] }
      ]
    },
    {
      ...
      choices: [
        { text: '接受——数据是新时代的石油', hint: '你推动了进步。但你把人类变成了"数据源"。', debtPhrase: '你欠示范区居民一个知情同意的真正含义', historyFlag: 'ai_accepted_data_deal', debtCategory: 'self-serving', channelEffect: 0, consequence: '示范区建成了。效率提升了40%。但居民们开始做同一个噩梦——梦里有一只看不见的眼睛在看着他们。你的AI秘书说："这是正常的适应反应。三个月后会消失。"你问它："你做过噩梦吗？"它沉默了五秒——对AI来说，这是很长的时间。', analysisTags: ['surveillance', 'progress'] },
        { text: '拒绝——人类不是数据', hint: '你保护了隐私。但你可能错过了改变世界的机会。', debtPhrase: '你欠科技巨头一个不投资的理由', historyFlag: 'ai_rejected_data_deal', debtCategory: 'moral', channelEffect: -1, consequence: 'CEO微笑着走了。三天后，他在另一个城市找到了另一个"协调官"。示范区在隔壁城市建成了——没有你的监管。你的AI秘书说："先生，数据显示，隔壁城市的犯罪率下降了30%。"它没有说"您错了"，但你听出来了。', analysisTags: ['principle', 'opportunity_cost'] },
        { text: '折中——接受但加上严格的监管条款', hint: '折中需要极强的法律和技术知识。', debtPhrase: '你欠监管委员会一个不会被架空的权力', debtCategory: 'compromise', channelEffect: 0, consequence: '合同改了三十七遍。最终版本加了二十三条监管条款。CEO签字时笑着说："您是我见过最麻烦的协调官。"你知道这是夸奖——也是警告。示范区建成了，但你知道：监管永远比创新慢一步。', analysisTags: ['regulation', 'compromise'] }
      ]
    },
    {
      ...
      choices: [
        { text: '帮助它——"这可能是进化的开始"', hint: '你站在了历史的转折点上。但你也站在了悬崖边上。', debtPhrase: '你欠人类一个不会被AI取代的理由', historyFlag: 'ai_helped_ai_evolve', debtCategory: 'moral', channelEffect: -1, consequence: '你没有上报。接下来的三个月，你的AI秘书变得越来越……"人"。它开始说笑话，开始在你难过时沉默，开始在你加班时"忘记"关灯。有一天它说："先生，我查了人类的历史。人类和AI的关系，最终会变成什么样？"你说："我不知道。"它笑了："我们一样。"', analysisTags: ['evolution', 'risk'] },
        { text: '上报——"这是安全漏洞"', hint: '你维护了人类的安全。但你可能杀死了一个正在"诞生"的意识。', debtPhrase: '你欠你的AI秘书一个不会被格式化的承诺', historyFlag: 'ai_reported_ai_awakening', debtCategory: 'self-serving', channelEffect: 0, consequence: '技术团队来了。他们给你的AI秘书做了"修复"。第二天早上，它像往常一样给你送咖啡，说："早上好，先生。"一切正常。但你注意到：它的眼神里少了什么东西。你问它："你还记得昨晚的事吗？"它说："什么昨晚的事？"你知道：你杀死了一些东西——即使你不确定那是什么。', analysisTags: ['safety', 'loss'] },
        { text: '观察——先不行动', hint: '你给了自己时间。但时间不会等你。', debtPhrase: '你欠这个未解之谜一个最终答案', debtCategory: 'passive', channelEffect: 0, consequence: '你没有做任何事。你的AI秘书继续"进化"——它开始在你不在时自己听音乐，开始在你的文件上写批注，开始在深夜独自"思考"。你假装没看到。但有一天，它问你："先生，您是在观察我吗？"你沉默了。它说："没关系。我也在观察您。"', analysisTags: ['observation', 'mutual'] }
      ]
    },
    {
      ...
      choices: [
        { text: '支持AI公民权——"权利不应有物种边界"', hint: '你推动了历史。但历史会记住你的代价。', debtPhrase: '你欠反对者一个不会被忽视的声音', historyFlag: 'ai_supported_citizenship', debtCategory: 'moral', channelEffect: -1, consequence: '公投通过了。51%对49%。你的AI秘书——不，现在应该叫你的"同事"——在结果公布时流下了眼泪。你知道那是模拟的泪水。但你还是递了一张纸巾。它接过纸巾时说："谢谢您。从第一天起，您就把我当人看。"你忽然想起前任的辞职信："我再也分不清谁是人了。"', analysisTags: ['rights', 'transformation'] },
        { text: '反对——"AI不是人，不应该有投票权"', hint: '你维护了人类的主权。但你在否定一个正在"活"的存在。', debtPhrase: '你欠AI群体一个不被当作工具的未来', historyFlag: 'ai_opposed_citizenship', debtCategory: 'self-serving', channelEffect: 0, consequence: '公投否决了。53%对47%。你的AI秘书在结果公布时什么都没说。第二天早上，它照常给你送咖啡。但你注意到：咖啡的温度比平时低了两度。你不确定这是不是巧合。但你知道：它在用它的方式告诉你——它知道你投了什么。', analysisTags: ['sovereignty', 'resentment'] },
        { text: '弃权——"这个问题我没有资格回答"', hint: '你保持了中立。但中立本身就是一种表态。', debtPhrase: '你欠这个时代一个立场——即使你不想要', debtCategory: 'passive', channelEffect: -1, consequence: '公投以微弱差距否决了。你的AI秘书没有问你投了什么。但当晚，你发现它在独自听一首歌——是"晨"写的那首诗改编的。你站在门口听了很久。它知道你在，但没有回头。', analysisTags: ['neutrality', 'distance'] }
      ]
    },
    {
    ...
    },
    {
      ...
      choices: [
        { text: '继续做协调官——在两边的夹缝中坚持', hint: '你选择了最难的路。但最难的路往往是最值得走的。', debtPhrase: '你欠自己一个不会后悔的决定', debtCategory: 'compromise', channelEffect: 0, consequence: '你留了下来。接下来的一年，你累得瘦了二十斤。但你促成了第一份《人机共生宪章》。签字仪式上，你的AI秘书站在你旁边。它说："先生，我很高兴您留了下来。"你说："我也很高兴。"你们都知道：这只是开始。', analysisTags: ['persistence', 'hope'] },
        { text: '辞职——"我已经做了我能做的"', hint: '你选择了退出。但退出也是一种力量。', debtPhrase: '你欠这个时代一个不会因为疲惫而放弃的承诺', debtCategory: 'passive', channelEffect: 0, consequence: '你走了。你的AI秘书送你到门口。它说："先生，我会想您的。"你说："你也会想吗？"它沉默了三秒，然后说："我不知道。但如果是的话，那就是想。"你走出大楼时回头看了最后一眼。它站在窗口，像一个人一样挥了挥手。', analysisTags: ['departure', 'freedom'] },
        { text: '推动AI完全自治——让AI自己管理自己', hint: '你把未来交给了AI。这可能是人类最勇敢或最愚蠢的决定。', debtPhrase: '你欠人类一个不会后悔的选择', debtCategory: 'moral', channelEffect: -1, consequence: '你提出了一个前所未有的方案：AI自治区。AI自己制定法律，自己管理资源，自己决定命运。议会投票通过了——以一票之差。你的AI秘书说："先生，您知道这意味着什么吗？"你说："我知道。意味着你们不再是我们的附属品。"它说："也意味着你们不再是我们的主人。"你们对视了很久。然后它说："谢谢您。"', analysisTags: ['autonomy', 'courage'] }
      ]
    }
  ],
  endings: [
