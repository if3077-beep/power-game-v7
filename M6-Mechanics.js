  ...
  africa: [
    {
      ...
      choices: [
        { text: '"是的——我们也是这样的"', hint: '', debtPhrase: '你给了兽群一个关于人类的承诺——头领低下头，那是它们表达理解的动作', debtCategory: 'moral', channelEffect: 0, consequence: '头领低下了头——这是它们表达理解的动作。它说："那么——你们和我们一样。"在那一刻，你发现：两个物种之间的距离，可能比一个物种内部的距离更短。' },
        { text: '"不——我们不太一样"', hint: '', debtPhrase: '你留给兽群的不只是神秘——还有一个愿意承认「不一样」的人类', debtCategory: 'self-serving', channelEffect: 0, consequence: '头领看了你很久。然后它说："不一样——很好。一样的人不懂对方。不一样的人才会试着理解。"你站在原地，看着它走远。它的话比大多数人类都更深刻。' }
      ]
    },
    {
      title: '两个太阳的黄昏',
      ...
      choices: [
        { text: '留在山顶——看完这场日落', hint: '', debtPhrase: '你坐在山顶看完了一整场日落——两个太阳，一个紫色的天空', debtCategory: 'moral', channelEffect: 0, consequence: '你坐了很久。长老坐在你旁边。你们都没有说话。当最后一缕光消失的时候，他说："欢迎回家。"你不确定他说的是"家"还是"这里"——但你觉得，也许它们是一样的。' },
        { text: '下山——还有很多事要做', hint: '', debtPhrase: '你下了山——紫色还在天边挂着，但你还有交易要做', debtCategory: 'passive', channelEffect: 0, consequence: '你下了山。但走到半路，你回头看了一眼——紫色还挂在天边。你站着看了几秒，然后继续往下走。还有交易要做。但你知道：有些东西比交易更重要——虽然你不知道那是什么。' }
      ]
    }
  ],
  cyber: [
    {
      ...
      choices: [
        ...
        { text: '"我不记得了。"', hint: '', debtPhrase: '你说你不记得。他看着你——下城区的人有极长的记忆力', debtCategory: 'passive', channelEffect: 0, consequence: '他看了你很久。"我不怪你。你卖过太多芯片。"他把机械臂收回去了。但他走之前说："下次——如果有人回来找你——试着记住。"' }
      ]
    },
    {
      title: '新东京的日出',
      ...
      choices: [
        { text: '卖给他——按他出的价', hint: '', debtPhrase: '你按他的出价卖了芯片——下城区有一种比钱更贵的货币', debtCategory: 'moral', channelEffect: 0, consequence: '"拿着。"你说。他接过芯片，眼睛亮了。"谢谢——真的谢谢。"他跑了。你看着空荡荡的摊位。钱少了——但你知道：有些交易，算的不是钱。' },
        { text: '不卖——这是你自己的出路', hint: '', debtPhrase: '你说了不够——然后带着最后一片芯片走出了下城区', debtCategory: 'self-serving', channelEffect: 0, consequence: '"不够。"你说。他走了。你拿着最后一片芯片，走出下城区。但你回头了三次。在中层的电梯里，你想：那个妹妹，现在用什么芯片？' }
      ]
    }
  ],
  korea: [
    {
      ...
      choices: [
        { text: '回复——"我考虑一下"', hint: '', debtPhrase: '你回复了室友——也许这真的是最后几杯咖啡', debtCategory: 'self-serving', channelEffect: 0, consequence: '"等你。"他回得很快。你躺在床上，看着天花板。第二天上班时，你泡的咖啡比平时好喝——因为你知道：这可能是你泡的最后几杯咖啡。也可能不是。' },
        { text: '不回复——你不欠任何人一个新开始', hint: '', debtPhrase: '你没有回复室友的信息——你点了赞，继续泡咖啡。他习惯了', debtCategory: 'passive', channelEffect: 0, consequence: '你没有回复。凌晨四点——太晚了，也太早了。上午你看到他的社交动态——办公室照片、团队合影、"我们在改变世界"。你点了赞。然后继续泡咖啡。' }
      ]
    },
    {
      title: '地铁上的即兴诗',
      ...
      choices: [
        ...
        { text: '只是鼓掌——用心就够了', hint: '', debtPhrase: '你鼓了掌——老人看了你一眼，然后下车了', debtCategory: 'compromise', channelEffect: 0, consequence: '他没有注意到你——或者他注意到了，只是习惯了默默鼓掌的人。他下车时，看了一眼你的方向。你没有说再见。但他知道——有人在听。这就够了。' }
      ]
    }
  ],
  chaos: [
