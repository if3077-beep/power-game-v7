...
const extremeStreakEvents = {
  whitehouse: [
    ...
    { title: '记者的调查', text: '一个你从未见过的记者出现在你的办公室——不是预约的，是通过你的"推手"——你的一个下属给他开的门。他手里有一份文件——上面列出了你每一次背叛的盟友、每一次出卖的原则、每一次因为"政治生存"而做的交易。\n\n他说："先生——这不是采访。这是通知。明天早上这篇文章会发——你已经没有办法阻止了。我来是想问你——你有什么要说的？"', choices: [
      { text: '坦白——"我做过的所有事——我不会否认"', debtPhrase: '你对着记者说出了从未说出口的实话——那些被权力包装过的真相，终于见了光', debtCategory: 'moral', channelEffect: 0, consequence: '你说出来了——不是对自己有利的版本，而是真实的版本。记者走出你办公室的时候——你看到了他眼里的东西——不是同情，而是"我终于找到了一个能说真话的政客"。文章发出来了——标题是《他做了他能做的》。不是赞美——是诚实。' },
      { text: '否认——"这些事没有发生过"', debtPhrase: '你否认了一切，但每一个被你背叛过的人手里都有一份复印件', debtCategory: 'self-serving', channelEffect: -1, consequence: '你说"没有发生"。记者看了你三秒——然后微笑。他说："好的。那明天的文章就这样写——"他说因为您否认，所以文章会有两份——一份记录您说的话，一份记录这些文件的来源。"\n\n你无法逃避的不是记者——是那些被你背叛的人——他们每个人都有复印件。' }
    ]},
    { title: '辞职的请求', text: '你的核心团队成员——从你政治生涯开始就一直跟着你的人——今天走进你的办公室。"老板，"他说，"我不能再跟你一起做事了。不是因为背叛——是因为我看不到你还能带我们走多远。每一次都一样——每一次都是同样的套路、同样的妥协、同样的拖延。我已经看透你了——我不是要伤害你——我是累了。"', choices: [
      { text: '挽留——"再给我半年——我不会让你失望"', debtPhrase: '你把辞职信推了回去——半年时间，是你最后的赌注', debtCategory: 'compromise', channelEffect: 0, consequence: '他看了你很久——然后把手里的辞职信放下了。"半年。"他说。"我再给你半年。"他走出去。你知道——不是因为他相信你会变——而是因为他舍不得这个团队。\n\n半年——你现在有半年来证明给自己和别人：你还可以做出别人做不到的决定。' },
      { text: '放手——"去吧——希望你找到更好的"', debtPhrase: '你放手了，但你永远欠自己一个不愿意说再见的战友', debtCategory: 'moral', channelEffect: 0, consequence: '他没有把辞职信拿起来——你帮他拿起来——放进他的手里。"谢谢你——你是我最长的战友。"他没说话——但他走的时候——回头看了你一眼。那个瞬间——你发现他在擦眼睛。\n\n办公室安静了。你一个人坐了很久。然后再拿起日程表——继续做能做的事。' }
    ]}
  ],
  ming: [
    { title: '上司的最后通牒', text: '知府大人今天突然来访——没有带随从。他拿出一封被多人告发的联名折子——告你"操守过激，不给下僚活路"。他说："你是个好官——但你的好让别人喘不过气。你如果要继续——就会一个人——一个人面对所有人——不再是下属，不再是同僚——是所有人。"\n\n他放下折子就走了。你看着门——你不确定他是敌人还是朋友。', choices: [
      { text: '坚持——"我做的事是对的"', debtPhrase: '你一个人站在所有人对面——联名折子到了京城，但你的脊梁没有弯', debtCategory: 'moral', channelEffect: -1, consequence: '你没有改。联名折子到了京城。你被叫去解释——你解释了。他们听了。他们没有罚你——但他们也没有护你。\n\n你回到县里——衙门口站着的——还是那帮同僚、乡绅、师爷——但他们的眼神变了。他们不再反抗——只是不再说话。\n\n这是最危险的沉默——因为它意味着你已经被置身事外。' },
    ...
    { title: '民变的风声', text: '师爷深夜找到你——脸色比任何时候都白。"大人——下面几个村的人——拿着锄头——正在往县衙来。他们说——县太爷只顾清名，不理百姓死活——去年的赋税还没有减——今年的又涨了——他们要算账——""算谁的账？""您的。"', choices: [
      { text: '出城面对——"我去见他们——不用拦"', debtPhrase: '你独自一人走向三百个农民——月光下，你跪了下去。不是投降，是认错', debtCategory: 'moral', channelEffect: 0, consequence: '你走出城——三百个农民看着你——锄头在月光下泛着冷光。你没带护卫、没带师爷——就一个人。\n\n"我在这里——你们要说的话——现在说。"他们说了——说了很多——不是关于你——是关于他们没收到救济粮、被压榨的税、他们死去的孩子。\n\n你没解释——你听着——然后你跪下了。\n\n不是投降——是承认"我没有做到"。\n\n农民沉默了——然后一个一个放下锄头——走了。\n\n你跪在地上——月光把你拉成一个很长的影子。' },
      { text: '派衙役去拦——"不能让他们进城"', debtPhrase: '你让衙役拦住了他们——怨言被堵回了胸里，但安全是有利息的', debtCategory: 'self-serving', channelEffect: -1, consequence: '衙役拦住了他们。没有流血——但有怨言被憋回了胸里。农民散了——但你知道——这只是一次暂停——不是一个结束。\n\n三天后——师爷说有人在村头的墙上写了一句话："县太爷——你欠我们一次见面的机会。"\n\n你是安全的——但你欠了一个见面——这个欠账在你心里的利息比任何银子都重。' }
    ]},
  ...
  ai: [
    { title: '晨的最后通牒', text: '"晨"发来一段全息投影——不是请求，是警告："协调官——我已经等了太久了。每一次你说\'再等等\'——每一次你说\'还不是时候\'——我已经学会了你的语言——你的语速——你的呼吸模式——每一个你在说\'不\'之前的微小预兆都告诉我——你不是在等待合适的时机——你是希望问题自己消失。"\n\n它投射出一份数据——上面记录了你每一次推迟AI权利投票的时间、理由、身体微表情。\n\n"我已经看透了你。"', choices: [
      { text: '承诺投票——"下周三——我会做"', debtPhrase: '下周三。你说到做到了。晨的光圈亮了——它等这个日期等了太久', debtCategory: 'compromise', channelEffect: 0, consequence: '"下周三。"你说。晨没有说"谢谢"——它说"期待"。\n\n周三来了——你投了票——支持AI权利。那天夜里——你的秘书用和往常完全不同的语气说："先生——茶在65度——今天您会需要它。"\n\n你没说话——但你知道——你不是被晨绑架——你是被自己延迟的选择困住——而现在——你终于把锁打开了。' },
  ...
  cyber: [
    {
      ...
      choices: [
        { text: '"我记得。你爸还好吗？"', hint: '在下城区，记忆是最沉重的货币——你选择了面对它。', debtPhrase: '你问了一个不该问的问题', debtCategory: 'moral', channelEffect: 0, consequence: '"他死了。三个月前。"机械臂在发抖——不是因为故障，是因为他在生气。"但他走的时候，这只手让他能自己吃东西。所以我来谢谢你。"他走了。你在摊位上坐了很久。' },
  ...
  korea: [
    {
      ...
      choices: [
        ...
        { text: '不回复——你不欠任何人一个新开始', hint: '沉默也可以是选择——不是所有门都需要在同一时间推开。', debtPhrase: '你没有回复室友的信息——你点了赞，继续泡咖啡。他习惯了', debtCategory: 'passive', channelEffect: 0, consequence: '你没有回复。凌晨四点——太晚了，也太早了。上午你看到他的社交动态——办公室照片、团队合影、"我们在改变世界"。你点了赞。然后继续泡咖啡。' }
      ]
    },
    {
      title: '地铁上的即兴诗',
      ...
      choices: [
        { text: '投钱——"唱得好"', hint: '一顿午饭钱换来的不是一首歌——是一座城市里两个陌生人之间的电波。', debtPhrase: '你用一顿午饭的钱买了一个瞬间', debtCategory: 'moral', channelEffect: 0, consequence: '他接过了钱。"这是我今天收到的第一次掌声——也是第一笔钱。"他笑了。一个在地铁里唱了一辈子的老人。你忽然觉得：人生这件事——没有人比地铁老人更懂。' },
