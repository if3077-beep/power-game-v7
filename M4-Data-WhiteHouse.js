  ...
  scenes: [
    {
      ...
      narrator: '「权力的本质不是发号施令，而是让别人心甘情愿地替你挡子弹。」——《白宫幕僚》\n\n判定理念：你在每个场景只有一次选择机会——不是游戏在限制你，而是你的第一反应已经暴露了立场。当同样的立场被反复选择，它就不再是一个个独立的决定，而是一种模式。而这个模式，最终会成为判决你结局的唯一依据。',
      choices: [
        {
        ...
        },
        {
          ...
          debtPhrase: '新闻发言人在直播间被追问到满头大汗——你欠她一次体面的回应',
        ...
        },
        {
          ...
          debtPhrase: '幕僚长眼底闪过一丝疲惫——你知道这次不能再透支他了',
    ...
    },
    {
      ...
      narratorVariants: [
        '判定理念：当两个盟友站在对立面，你必须在一次选择中表态，没有"都不得罪"的选项——因为沉默本身就是一种选择。在你犹豫之前，本能已经替你做了决定。而这正是路径依赖的起点：每一次"站队"都在压缩下一次可以站的队伍数量。',
        '在权力的角斗场上，中立不是一种美德——它是一种奢侈。而大多数时候，你没有这种奢侈。这座游戏不给你"以后再决定"的选项，因为真实世界里，会议桌上的沉默会被所有人解读为一种立场——而且往往是最糟糕的那种。'
      ],
      choices: [
        {
        ...
        },
        {
          ...
          debtPhrase: '两个部长都在等你的答案——你只是把皮球踢给了下周的自己',
          debtCategory: 'passive',
          channelEffect: -1,
      ...
      choices: [
        {
          ...
          debtPhrase: '你今晚会失眠——因为你知道有些问题只是被推迟了，没有被解决',
          debtCategory: 'moral',
          channelEffect: 0,
        ...
        },
        {
          ...
          debtPhrase: '真相被藏起来了——但它迟早会找到一扇你没锁好的门',
        ...
        },
        {
          ...
          debtPhrase: '女儿已经很久没有和你安安静静吃过一顿晚饭了',
          debtCategory: 'moral',
          channelEffect: 0,
      ...
      choices: [
        {
          ...
          debtPhrase: '七年的信任——如果要说再见，至少该体面一点',
          debtCategory: 'betrayal',
          channelEffect: 0,
    ...
    },
    {
      ...
      choices: [
        ...
        },
        {
          ...
          debtPhrase: '多数党领袖做出了真正的让步——这笔人情记在你头上了',
          debtCategory: 'compromise',
          channelEffect: 0,
      ...
      choices: [
        {
          ...
          debtPhrase: '今天下午不用对镜头微笑——你终于可以做五分钟的自己',
          debtCategory: 'moral',
          channelEffect: 0,
        ...
        },
        {
          ...
          debtPhrase: '五名抗议代表需要一句话带回给他们身后的人——你给了他们这句话',
          debtCategory: 'compromise',
          channelEffect: 0,
