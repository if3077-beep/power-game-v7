...
class AudioEngine {
  ...
  startBGM(style) {
    ...
    const configs = {
      whitehouse: {
        // 白宫：小调式弦乐质感，紧张而庄严，更丰富的低音行进
        melody:  [220, 247, 261, 293, 330, 349, 330, 311, 293, 261, 247, 220, 196, 220],
        harmony: [110, 130, 130, 146, 165, 175, 165, 155, 146, 130, 130, 110,  98, 110],
        bass:    [55,  65,  65,  73,  82,  87,  82,  77,  73,  65,  65,  55,  49,  55],
        wave: 'triangle', harmWave: 'sine', tempo: 2000, melVol: 0.3, harmVol: 0.16, bassVol: 0.2,
      },
      ming: {
        // 大明：五声调式，古筝般空灵，更慢更有韵味
        melody:  [261, 293, 329, 392, 440, 523, 587, 523, 440, 392, 329, 293, 261, 220],
        harmony: [130, 146, 165, 196, 220, 261, 293, 261, 220, 196, 165, 146, 130, 110],
        bass:    [65,  73,  82,  98, 110, 130, 147, 130, 110,  98,  82,  73,  65,  55],
        wave: 'sine', harmWave: 'triangle', tempo: 2800, melVol: 0.24, harmVol: 0.14, bassVol: 0.15,
      },
      ai: {
        // AI共生：高频电子脉冲，更广音域，未来感更强
        melody:  [440, 523, 659, 784, 880, 1047, 880, 784, 659, 523, 440, 349, 392, 440],
        harmony: [220, 261, 330, 392, 440, 523, 440, 392, 330, 261, 220, 175, 196, 220],
        bass:    [110, 130, 165, 196, 220, 261, 220, 196, 165, 130, 110,  87,  98, 110],
        wave: 'sine', harmWave: 'triangle', tempo: 1600, melVol: 0.22, harmVol: 0.12, bassVol: 0.16,
      },
      africa: {
        // 非洲之心：大地鼓点，更有部落仪式感的节奏
        melody:  [196, 220, 261, 293, 349, 392, 349, 293, 261, 220, 261, 293, 196, 175],
        harmony: [98,  110, 130, 146, 175, 196, 175, 146, 130, 110, 130, 146,  98,  87],
        bass:    [49,  55,  65,  73,  87,  98,  87,  73,  65,  55,  65,  73,  49,  44],
        wave: 'triangle', harmWave: 'sine', tempo: 2200, melVol: 0.24, harmVol: 0.14, bassVol: 0.22,
      },
      cyber: {
        // 3077：暗色合成器，半音阶下行，低频更重更有压迫感
        melody:  [330, 311, 293, 277, 261, 247, 233, 247, 261, 293, 311, 330, 349, 370],
        harmony: [165, 155, 146, 139, 130, 124, 117, 124, 130, 146, 155, 165, 175, 185],
        bass:    [82,  77,  73,  69,  65,  62,  58,  62,  65,  73,  77,  82,  87,  93],
        wave: 'sawtooth', harmWave: 'square', tempo: 1400, melVol: 0.16, harmVol: 0.1, bassVol: 0.26,
      },
      cyber_high: {
        // 3077高强度：更重的不协和音，更快，更强的压迫感
        melody:  [311, 293, 277, 261, 247, 233, 220, 233, 247, 277, 311, 349, 370, 392],
        harmony: [155, 146, 139, 130, 124, 117, 110, 117, 124, 139, 155, 175, 185, 196],
        bass:    [77,  73,  69,  65,  62,  58,  55,  58,  62,  69,  77,  87,  93,  98],
        wave: 'sawtooth', harmWave: 'sawtooth', tempo: 1000, melVol: 0.12, harmVol: 0.08, bassVol: 0.3,
      },
      korea: {
        // 日常投影：大调，温暖吉他质感，更舒缓
        melody:  [330, 392, 440, 494, 523, 587, 523, 494, 440, 392, 349, 330, 294, 330],
        harmony: [165, 196, 220, 247, 261, 293, 261, 247, 220, 196, 175, 165, 147, 165],
        bass:    [82,  98, 110, 124, 130, 147, 130, 124, 110,  98,  87,  82,  74,  82],
        wave: 'sine', harmWave: 'triangle', tempo: 3000, melVol: 0.22, harmVol: 0.12, bassVol: 0.14,
      },
      encounter: {
        // 奇遇：紧张急促，戏剧性增强
        melody:  [293, 349, 392, 440, 523, 587, 523, 440, 392, 349, 293, 261, 247, 293],
        harmony: [146, 175, 196, 220, 261, 293, 261, 220, 196, 175, 146, 130, 124, 146],
        bass:    [73,  87,  98, 110, 130, 147, 130, 110,  98,  87,  73,  65,  62,  73],
        wave: 'triangle', harmWave: 'sine', tempo: 1300, melVol: 0.32, harmVol: 0.16, bassVol: 0.22,
      },
      crisis: {
        // 渠道危机：紧迫不协和，更尖锐
        melody:  [261, 277, 311, 330, 370, 392, 370, 330, 311, 277, 261, 247, 233, 261],
        harmony: [130, 139, 155, 165, 185, 196, 185, 165, 155, 139, 130, 124, 117, 130],
        bass:    [65,  69,  77,  82,  93,  98,  93,  82,  77,  69,  65,  62,  58,  65],
        wave: 'sawtooth', harmWave: 'triangle', tempo: 1100, melVol: 0.2, harmVol: 0.12, bassVol: 0.24,
      },
      penalty: {
        // V14.1: 惩罚危机 — 极度不协和，压迫感最强
        melody:  [233, 247, 277, 311, 349, 311, 277, 247, 233, 220, 208, 233],
        harmony: [117, 124, 139, 155, 175, 155, 139, 124, 117, 110, 104, 117],
